...
/*   Updated: 2020/11/08 18:10:22 by alexandre        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int ac, char **av)
{
    ...
    *nb7 = 8;
    ...
    ft_list_push_front(&list2, (void *)nb7);
    ...
    *modulo = 3;
    ...
    ft_list_sort(&list2, &ft_intcmp);
    ft_print_list(list2);
    printf("*-----------------------*\n");
    ft_sorted_list_merge(&list, list2, &ft_intcmp);
    ft_print_list(list);
}
